...
class _ProfileScreenState extends State<ProfileScreen> {
      ...
      child: Column(
        ...
        children: [
          CircleAvatar(
            ...
            onBackgroundImageError: _userAvatarUrl != null && _userAvatarUrl!.isNotEmpty
                ? (exception, stackTrace) { print('Error loading profile image: $exception'); }
                : null,
          ),
          ...
          ElevatedButton(
            ...
            child: const Text('프로필 수정', style: TextStyle(fontSize: 15, fontWeight: FontWeight.w500)),
          ),
        ],
      ),
    );
          ...
          child: Row(
            children: [
              ...
              Expanded(
                child: Text(
                  title,
                  style: TextStyle(fontSize: 16, color: textColor ?? Colors.black87, fontWeight: FontWeight.w500),
                ),
              ),
  ...
  Widget build(BuildContext context) {
    ...
    return Container( // ProfileScreen 컨텐츠의 배경색 설정 (메뉴 그룹 사이의 간격 색)
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                const Divider(height: 1, indent: 20, endIndent: 20, thickness: 0.5),
                _buildMenuListItem(
                  ...
                  builder: (BuildContext dialogContext) {
                    return AlertDialog(
                      ...
                      actions: <Widget>[
                        ...
                        TextButton(
                          child: const Text('로그아웃', style: TextStyle(color: Colors.red, fontWeight: FontWeight.bold, fontSize: 15)),
                          onPressed: () {
